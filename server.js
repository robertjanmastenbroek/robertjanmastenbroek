...
async function sendVonageSMS(to, body) {
  ...
  // If VONAGE_PHONE_NUMBER is set, use it as sender (avoids alpha sender issues)
  // Otherwise use VONAGE_FROM (alpha sender) or default 'HolyRave'
