...
async function createRegistration({ id, firstName, lastName, email, phone, amount, quantity, week, stripeSessionId, eventId }) {
  ...
  await sql`
    INSERT INTO holy_rave_registrations (id, first_name, last_name, email, phone, amount_cents, quantity, status, week, stripe_session_id, event_id)
    VALUES (${id}, ${firstName}, ${lastName}, ${email}, ${phone || null}, ${amount}, ${qty}, ${status}, ${week || null}, ${stripeSessionId || null}, ${eventId || null})
  `;
