# YouTube DJ Mix Strategy — Robert-Jan Mastenbroek

*Strategy: `youtube_dj_mixes` | Built: 2026-04-14*
...
### 1. "Jericho Mix" — 140 BPM Psytrance Journey (60 min)
- **Concept:** Full-force tribal psytrance set anchored by "Jericho." The walls don't fall by force — they fall by sound. Mix builds like the army circling the city — patient, then explosive.
- **SEO Title:** `Jericho Mix — Tribal Psytrance Journey 2026 [140 BPM] | Robert-Jan Mastenbroek`
- **Hook:** Opening shot: close-up of speakers in a dark room. First kick hits at 0:04.
- **Sacred geometry thumbnail:** Gold circle with crumbling walls emerging from waveform.
...
- **SEO Title:** `Deep Space Selah — Ambient Psytrance & Downtempo Mix 2026 | Robert-Jan Mastenbroek`
- **Hook:** "Two hours. No small talk."
- **Thumbnail:** Space imagery with sacred geometry overlay. Extreme contrast. Single point of light.
- **Tracklist arc:** Pure ambient intro → psychill build → ambient psytrance peak → total stillness finish
...
```
[EVOCATIVE OPENING LINE — 1 sentence, visual, no adjectives]

🎵 [MIX NAME] — [GENRE] | [DURATION]
Recorded/mixed by Robert-Jan Mastenbroek | Tenerife

Stream on Spotify: https://open.spotify.com/artist/2Seaafm5k1hAuCkpdq7yds
Follow on Instagram: @robertjanmastenbroek

TRACKLIST:
00:00 — [Track 1 - Artist]
[continue...]

Booking: motomotosings@gmail.com
...
## Publishing Schedule
- 1 mix per month minimum
- Upload day: Friday (algorithmic peak for discovery)
- Premiere mode: Use YouTube Premiere for first 3 mixes to build chat + community

## Spotify Conversion CTA
Every mix includes:
- Pinned comment with Spotify link (posted within 5 min of upload)
- End card: "Stream the originals on Spotify" with artist link
- Description first line routes to Spotify

## Cross-Platform Distribution
- YouTube upload → clip for TikTok/Reels (best 30s moment, caption "this part hits different at 3am")
- Thumbnail repurposed as IG story graphic
- Mix title becomes email subject line for outreach
