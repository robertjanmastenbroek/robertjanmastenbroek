    ...
    for meta in post_ids:
        ...
        try:
            ...
            records.append(PerformanceRecord(
                ...
                hook_template_id=meta.get("hook_template_id", ""),
                hook_sub_mode=meta.get("hook_sub_mode", ""),
                transitional_category=meta.get("transitional_category", ""),
                transitional_file=meta.get("transitional_file", ""),
